...
<img src="gui/public/icon.svg" alt="Lucifer Logo" width="200" height="200"/>
...
### ✅ Core Requirements
- [x] AI assistant for cybersecurity automation
- [x] Terminal output capture and analysis
- [x] Computer vision for GUI automation
- [x] Bug bounty and pentesting workflows
- [x] Multiple AI provider support (Claude, GPT-4, Ollama)
- [x] Production-ready code quality

### ✅ GUI Requirements
- [x] React-based desktop application (not web-based)
- [x] Electron for native desktop integration
- [x] Icon shows in application manager after installation
- [x] Desktop shortcut with icon
- [x] Logo in public folder
- [x] Logo used in documentation
...
**[📘 Main README](README.md)** | **[🚀 Quick Start](QUICKSTART.md)** | **[📦 Install Guide](INSTALL_GUIDE.md)**

**[🖥️ GUI Docs](gui/GUI_README.md)** | **[💖 Donate](DONATE.md)** | **[🤝 Contribute](CONTRIBUTING.md)**
